 ...
 */
public class ConnectivityServ extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private static final int COPY_CONTENT_BUFFER_SIZE = 1024;
    private static final Logger LOGGER = LoggerFactory.getLogger(ConnectivityServ.class);
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // list of all working destinations
        // ZermattSalesOrder
        // ZermattSalesOrder2
        ...
        try {
            ...
            if (statusCode != HTTP_OK) {
                throw new ServletException("Expected response status code is 200 but it is " + statusCode + " ." +"[Destination URI: " + destination.getURI() + "]");
            }
            ...
            if (entity != null) {
                ...
                try {
                    ...
                    //throw new ServletException(destination.getURI().toString());
